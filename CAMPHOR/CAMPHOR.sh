...
python3 $SRC/SV_support_read.2.py $OUTPUT/SV_read.txt.2 500 CHR > $OUTPUT/CHR_candidate.txt
...
python3 ./src/INS_filt.py $OUTPUT/INS_candidate.txt2|python3 ./src/INS_filt2.py /dev/stdin 20 100 0.1 300 1 8 $MIN_READ_NUMBER 1 1|python3 ./src/INS_VAF.py /dev/stdin $SORTED_BAM 0 30 2 4 7 9 > $OUTPUT/INS_candidate.txt2.VAF
...
python3 ./src/INS_filt3.py $OUTPUT/INS_candidate.txt2.VAF 1000 $MIN_READ_NUMBER $MIN_READ_NUMBER,$MIN_READ_NUMBER $MIN_VAF 0.8 > $OUTPUT/INS_candidate.filtered.txt
...
python3 ./src/TRS_filt.py $OUTPUT/TRS_candidate.txt2|python3 ./src/TRS_filt2.py /dev/stdin 20 500 0.1 0.1 800 1 7 $MIN_READ_NUMBER 1 1|python3 ./src/add_rep.py $SEGDUP /dev/stdin > $OUTPUT/TRS_candidate.txt2.2

#echo "python ./src/add_rep2.py $SELF_CHAIN $OUTPUT/TRS_candidate.txt2.2 > $OUTPUT/TRS_candidate.txt2.3"
python3 ./src/add_rep2.py $SELF_CHAIN $OUTPUT/TRS_candidate.txt2.2 > $OUTPUT/TRS_candidate.txt2.3
...
python3 ./src/rep_filter.py $OUTPUT/TRS_candidate.txt2.3 -4 -3|python3 ./src/rep_filter.py /dev/stdin -2 -1|python3 ./src/VAF.py /dev/stdin $SORTED_BAM $MIN_VAF 30 0.5 4 8 > $OUTPUT/TRS_candidate.txt2.4

#echo "python ./src/SB_CH2.py $OUTPUT/TRS_candidate.txt2.4 $FASTQ 2 11 11 > $OUTPUT/TRS_candidate.txt2.5"
python3 ./src/SB_CH2.py $OUTPUT/TRS_candidate.txt2.4 $FASTQ 2 11 11 > $OUTPUT/TRS_candidate.txt2.5
...
python3 ./src/add_rep3.py $SR $OUTPUT/TRS_candidate.txt2.5 2000|python3 ./src/add_rep3.py $RMSK /dev/stdin 2000 > $OUTPUT/TRS_candidate.txt2.6
...
python3 ./src/TRS_filt3.py $OUTPUT/TRS_candidate.txt2.6 0.8 50|python3 ./src/TRS_filt4.py /dev/stdin 10 0.3 > $OUTPUT/TRS_candidate.filtered.txt
...
python3 ./src/TRS_filt.py $OUTPUT/CHR_candidate.txt2|python3 ./src/TRS_filt2.py /dev/stdin 20 500 0.1 0.1 800 1 7 $MIN_READ_NUMBER 1 1 > $OUTPUT/CHR_candidate.txt2.2

#echo "python ./src/add_rep.py $SEGDUP $OUTPUT/CHR_candidate.txt2.2 > $OUTPUT/CHR_candidate.txt2.3"
python3 ./src/add_rep.py $SEGDUP $OUTPUT/CHR_candidate.txt2.2 > $OUTPUT/CHR_candidate.txt2.3

#echo "python ./src/add_rep2.py $SELF_CHAIN $OUTPUT/CHR_candidate.txt2.3 > $OUTPUT/CHR_candidate.txt2.4"
python3 ./src/add_rep2.py $SELF_CHAIN $OUTPUT/CHR_candidate.txt2.3 > $OUTPUT/CHR_candidate.txt2.4
...
python3 ./src/rep_filter.py $OUTPUT/CHR_candidate.txt2.4 -4 -3|python3 ./src/rep_filter.py /dev/stdin -2 -1 > $OUTPUT/CHR_candidate.txt2.5

#echo "python ./src/VAF.py $OUTPUT/CHR_candidate.txt2.5 $SORTED_BAM $MIN_VAF 30 0.5 4 8 > $OUTPUT/CHR_candidate.txt2.6"
python3 ./src/VAF.py $OUTPUT/CHR_candidate.txt2.5 $SORTED_BAM $MIN_VAF 30 0.5 4 8 > $OUTPUT/CHR_candidate.txt2.6

#echo "python  ./src/SB_CH2.py $OUTPUT/CHR_candidate.txt2.6 $FASTQ 2 11 11 > $OUTPUT/CHR_candidate.txt2.7"
python3  ./src/SB_CH2.py $OUTPUT/CHR_candidate.txt2.6 $FASTQ 2 11 11 > $OUTPUT/CHR_candidate.txt2.7

#echo "python ./src/TRS_filt4.py $OUTPUT/CHR_candidate.txt2.7 10 0.3 > $OUTPUT/CHR_candidate.filtered.txt"
python3 ./src/TRS_filt4.py $OUTPUT/CHR_candidate.txt2.7 10 0.3 > $OUTPUT/CHR_candidate.filtered.txt
...
python3 ./src/TRS_filt.py $OUTPUT/INV_candidate.txt2|python3 ./src/TRS_filt2.py /dev/stdin 20 500 0.1 0.1 800 1 7 $MIN_READ_NUMBER 1 1 > $OUTPUT/INV_candidate.txt2.2

#echo "python ./src/add_rep.py $SEGDUP $OUTPUT/INV_candidate.txt2.2 > $OUTPUT/INV_candidate.txt2.3"
python3 ./src/add_rep.py $SEGDUP $OUTPUT/INV_candidate.txt2.2 > $OUTPUT/INV_candidate.txt2.3

#echo "python ./src/add_rep2.py $SELF_CHAIN $OUTPUT/INV_candidate.txt2.3 > $OUTPUT/INV_candidate.txt2.4"
python3 ./src/add_rep2.py $SELF_CHAIN $OUTPUT/INV_candidate.txt2.3 > $OUTPUT/INV_candidate.txt2.4
...
python3 ./src/rep_filter.py $OUTPUT/INV_candidate.txt2.4 -4 -3|python3 ./src/rep_filter.py /dev/stdin -2 -1 > $OUTPUT/INV_candidate.txt2.5

#echo "python ./src/VAF.py $OUTPUT/INV_candidate.txt2.5 $SORTED_BAM $MIN_VAF 30 0.5 4 8 > $OUTPUT/INV_candidate.txt2.6"
python3 ./src/VAF.py $OUTPUT/INV_candidate.txt2.5 $SORTED_BAM $MIN_VAF 30 0.5 4 8 > $OUTPUT/INV_candidate.txt2.6

#echo "python  ./src/SB_CH2.py $OUTPUT/INV_candidate.txt2.6 $FASTQ 2 11 11 > $OUTPUT/INV_candidate.txt2.7"
python3  ./src/SB_CH2.py $OUTPUT/INV_candidate.txt2.6 $FASTQ 2 11 11 > $OUTPUT/INV_candidate.txt2.7
...
python3 ./src/add_rep3.py $SR $OUTPUT/INV_candidate.txt2.7 2000|python3 ./src/add_rep3.py $RMSK /dev/stdin 2000 > $OUTPUT/INV_candidate.txt2.8
...
python3 ./src/TRS_filt3.py $OUTPUT/INV_candidate.txt2.8 0.8 50|python3 ./src/INV_filt.py /dev/stdin 0.8 12|python3 ./src/TRS_filt4.py /dev/stdin 10 0.3 >  $OUTPUT/INV_candidate.filtered.txt
...
python3 ./src/vcf.py $OUTPUT/DEL_candidate.filtered.txt $OUTPUT/INS_candidate.filtered.txt $OUTPUT/INV_candidate.filtered.txt $OUTPUT/TRS_candidate.filtered.txt $OUTPUT/CHR_candidate.filtered.txt > $OUTPUT/SV.vcf
